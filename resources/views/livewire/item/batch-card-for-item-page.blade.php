    ...
    <div class=" basis-3/4 flex items-center   justify-between border" >
        ...
        <div class=" basis-1/5" wire:click ="batchUpdateRequest({{ $batch }})">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentcolor" class="w-6 h-6">
                <path d="M21.731 2.269a2.625 2.625 0 00-3.712 n-1.157 1.157 3.712 3.712 1.157-1.157a2.625 2.625 0 000-3.712zM19.513 8.199l-3.712-3.712-8.4 8.4a5.25 5.25 0 00-1.32 2.214l-.8 2.685a.75.75 0 00.933.933l2.685-.8a5.25 5.25 0 002.214-1.32l8.4-8.4z" />
        ...
        <button class="btn btn-info">{{ $availableQty }}</button>
